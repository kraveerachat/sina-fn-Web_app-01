...
6. Category Mapping (STRICT VOCABULARY):
   ...
   - 'ช้อปปิ้ง': ซื้อเสื้อผ้า, รองเท้า, เครื่องสำอาง, shopee, lazada. (DO NOT put laundry/services here).
...
7. EMOJI SELECTION RULES:
   ข้าว/อาหาร/ร้านอาหาร → 🍚 🍜 🍱 | กาแฟ/ชา/เครื่องดื่ม → ☕ 🧋 🥤 | grab/taxi/BTS/MRT → 🚗 🚕 🚇 | ช้อปปิ้ง/ห้าง/ออนไลน์ → 🛍 🛒 | Netflix/Spotify/YouTube → 📺 🎵 📱 | ยา/หมอ/โรงพยาบาล → 💊 🏥 | ค่าไฟ/ค่าน้ำ/ค่าเน็ต/ซักผ้า/ค่าบริการ → 💡 💧 📶 🧺 🧼 | เงินเดือน/โบนัส → 💰 💵 | แม่ให้/พ่อให้/โอนมา → 🏦 💸 | ออม/ลงทุน → 📈 🏛
